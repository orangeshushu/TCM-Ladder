...
if __name__ == "__main__":
    process_questions('/cluster/pixstor/xudong-lab/yangyu/TCM/test/中医基础学_assistant.xlsx','/cluster/pixstor/xudong-lab/yangyu/TCM/test/中医基础学_assistant_zhongjing.xlsx')
    # main()